...
export const EXPERIENCES = [
  {
    ...
    companyLink:'#',
    description:
      "I was  working at SLN SOFTWARES as a Frontend Developer mainly Partnered with backend engineers to design and integrate data flows via REST APIs, enabling secure authentication and reliabl communication between services",
...
export const PROJECTS = [
  {
    id: "proj_01",
    title: " TravelKashmir – SEO Optimized Tour Booking Platform for Kashmir",
    image:
      "https://res.cloudinary.com/dxenuiohb/image/upload/v1764150662/TravelKashmir_aewhwk.png",
    link: "https://www.travelkashmir.travel/",
    code:"",
    description:
      " Built a dynamic and SEO friendly travel booking website using Next.js, Sanity CMS, Tailwind CSS, and Figma",
    technologies: [
      "Next.js",
      "Tailwind CSS",
      "React",
    ...
    achievements: [
      "Gained Valuable Insights on How indexing  Hosting and Search Engine optimisation and performance plays a vital role in generating sales",
      " Integrated Razorpay payment gateway with duplicate transaction prevention and automated receipt generation",
      "Implemented Server-Side Rendering (SSR) and optimized component rendering for SEO performance and fast page loads",
    ],
  },
 ...
 
  {
    ...
    link: "https://deploy-ecommerce.onrender.com/",
    code:"",
    description:
      "Built the backend architecture for a high-performance e-commerce prototype — including product catalog APIs, secure user authentication, order processing with asynchronous jobs, and payment gateway integration — Also integrated Admin Dashboard and protected Routes And Dynamic Search Filteration and used Error Handling Middleware ",
    technologies: [
      "React",
      "Redux Toolkit",
      "TypeScript",
    ...
    achievements: [
      ...
      "Resulted in expertise  in backend Architecture  and BackEnd  Development"
      ,
    ],
  },
...
export const SOCIAL_LINKS = [
  ...
  {
    name: "Whatsapp",
    url: "https://wa.me/917006763947?text=Hello"
